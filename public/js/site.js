$(function() {
            ...
            if(state == 'success') {
                ...
                setTimeout(function() {
                    ...
                    if(hash) {
                        var $hashEl = $(hash);
                        if($hashEl.length > 0) {
                            $('html, body').animate({scrollTop:$hashEl.offset().top - 100}, 400);
                        }
                    }
                }, delay);
            }
    ...
    $(document)
        .on('click', '.intro-arrow', function(e) {
            ...
            $('html, body').animate({'scrollTop':wh}, 460);
        })
    ...
    function MyVideo(video) {
        ...
        this._formatTime = function(sec) {
            ...
            var t_sec = Math.round(sec - (t_min*60)).toString(); t_sec = (t_sec.length == 1 ? '0' + t_sec : t_sec);
